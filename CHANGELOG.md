...
### Added
- Added `ai-native-software-dev` 0.1.0, an evidence-driven workflow for brownfield, greenfield, and authorized reference-reconstruction software development, with risk-scaled quality controls, conditional lifecycle modules, and extensible domain packs.

### Changed
- Added a quick overview and invocation example for the new skill to `README.md`.
- Updated plugin and extension manifests to version 1.1.0.
...
### Changed
- Unified all skill versions to 1.0.3
- Updated CHANGELOG.md for consistency
